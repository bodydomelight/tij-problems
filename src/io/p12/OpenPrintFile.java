...
public class OpenPrintFile {
    ...
    public static void writeToFileWithLineNumbers(List<String> list, String fileName) throws FileNotFoundException {
        long lineNumber = 1;
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        if (args.length != 1) {
            ...
            writeToFileWithLineNumbers(readFile(args[0]), ".\\src\\io\\p12\\out_test.txt");
        }
    }
}
